...
def launch_setup(context, *args, **kwargs):
    ...
    parent_frame = LaunchConfiguration('parent_frame',  default = 'camera_link')
...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("params_file", default_value=os.path.join(depthai_prefix, 'config/oakd_config', 'oakd_camera_base.param.yaml')),
        DeclareLaunchArgument("use_rviz", default_value='false'),
        DeclareLaunchArgument("rviz_config", default_value=os.path.join(depthai_prefix, "rviz", "rgbd.rviz")),
